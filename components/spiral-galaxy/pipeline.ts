// GPU resources and the per-frame chain: simulate (compute) → stars (additive
// quads into an HDR scene) → bloom (half- and quarter-resolution Gaussian
// pairs) → composite (flare, dirty glass, ACES) into the output.
